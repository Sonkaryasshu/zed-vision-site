...
exports.renderToStaticNodeStream=function(a,b){return new fb(a,!0,b)};exports.renderToString=function(a,b){a=new cb(a,!1,b);try{return a.read(Infinity)}finally{a.destroy()}};exports.version="17.0.0-rc.2";
...
async function renderWorker(code, props) {
  const componentFactory = new Function("props", "React", `try{${code}; return Counter(props)}catch(e){console.log(e); return ()=>React.createElement("div", null, "Error in render")}`);

  const Counter = props => componentFactory(props, react__WEBPACK_IMPORTED_MODULE_0__);

  return String(react_dom_server__WEBPACK_IMPORTED_MODULE_1___default.a.renderToString( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["createElement"](Counter, props))).toString();
}
...
/******/ });
//# sourceMappingURL=3eedeb73aebb9bb146fc.worker.js.map