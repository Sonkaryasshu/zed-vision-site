...
module.exports = function () {
  var w = new Worker(__webpack_require__.p + "built-editor.5ba1ba.worker.js", {
    name: "built-editor.[hash:6].worker.js"
  });
...
function jsonParser_parse(textDocument, config) {
  ...
  function _parseArray(parent) {
    ...
    /* EOF */
      ...
      if (!item) {
        _error(jsonParser_localize('PropertyExpected', 'Value expected'), ErrorCode.ValueExpected, undefined, [], [4
        /* CloseBracketToken */
        , 5
        /* CommaToken */
        ]);
  ...
  function _parseObject(parent) {
    ...
    /* EOF */
      ...
      if (!property) {
        _error(jsonParser_localize('PropertyExpected', 'Property expected'), ErrorCode.PropertyExpected, undefined, [], [2
        /* CloseBraceToken */
        , 5
        /* CommaToken */
        ]);
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (document) {
          ...
          return [2
          /*return*/
          , this._languageService.doValidation(document, jsonDocument)];
        }
...
// CONCATENATED MODULE: ./node_modules/workerize-loader/dist/rpc-worker-loader.js!./node_modules/monaco-editor/esm/vs/language/json/json.worker.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/***/ })
/******/ ]);
//# sourceMappingURL=built-json.c429e1.worker.js.map