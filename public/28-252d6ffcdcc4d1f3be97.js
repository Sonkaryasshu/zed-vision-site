...
var monaco_editor_core = __webpack_require__(216);
...
var workerManager_WorkerManager =
/** @class */
function () {
    ...
    if (!this._client) {
      ...
      if (this._defaults.getEagerModelSync()) {
        p = p.then(function (worker) {
          if (_this._worker) {
            return _this._worker.withSyncedResources(monaco_editor_core["editor"].getModels().filter(function (model) {
...
function () {
  ...
  LibFiles.prototype.getOrCreateModel = function (uri) {
    ...
    if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
      return monaco_editor_core["editor"].createModel(this._libFiles[uri.path.slice(1)], 'javascript', uri);
    }
      ...
      return languageFeatures_generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            monaco_editor_core["editor"].setModelMarkers(model, this._selector, diagnostics.map(function (d) {
...
var languageFeatures_SuggestAdapter =
/** @class */
function (_super) {
...
var languageFeatures_OccurrencesAdapter =
/** @class */
function (_super) {
          ...
          case 2:
            ...
            , entries.map(function (entry) {
              return {
                ...
                kind: entry.isWriteAccess ? monaco_editor_core["languages"].DocumentHighlightKind.Write : monaco_editor_core["languages"].DocumentHighlightKind.Text
              };
            })];
        }
      });
...
var languageFeatures_DefinitionAdapter =
/** @class */
function (_super) {
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            , this._libFiles.fetchLibFilesIfNecessary(entries.map(function (entry) {
              return monaco_editor_core["Uri"].parse(entry.fileName);
            }))];
...
var languageFeatures_ReferenceAdapter =
/** @class */
function (_super) {
...
var languageFeatures_OutlineAdapter =
/** @class */
function (_super) {
...
outlineTypeTable[Kind.localFunction] = monaco_editor_core["languages"].SymbolKind.Function; // --- formatting ----
...
var languageFeatures_RenameAdapter =
/** @class */
function (_super) {
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            for (_i = 0, renameLocations_1 = renameLocations; _i < renameLocations_1.length; _i++) {
              ...
              edits.push({
                resource: monaco_editor_core["Uri"].parse(renameLocation.fileName),
                edit: {
...
function setupMode(defaults, modeId) {
  ...
  monaco_editor_core["languages"].registerSignatureHelpProvider(modeId, new SignatureHelpAdapter(worker));
...
//# sourceMappingURL=28-252d6ffcdcc4d1f3be97.js.map