...
})(["text-align:center;border-radius:25px;width:200px;height:200px;display:flex;place-content:center;place-items:center;margin:0;padding:0;background:rgb(255,255,255) none repeat scroll 0% 0%;user-select:none;box-shadow:rgba(0,0,0,0.1) 0px 2px 3px 0px,rgba(0,0,0,0.06) 0px 10px 15px 0px;"]);
var Container = styled_components_browser_esm["b" /* default */].div.withConfig({
  displayName: "zzz__Container",
  componentId: "sc-11tle59-1"
})(["text-align:center;width:99vw;height:99vh;display:flex;place-content:center;place-items:center;background:rgba(0,85,255,1);margin:0;padding:0;perspective:1000px;"]);
var zzz_MyComponent = function MyComponent(_ref) {
  var children = _ref.children;
  var x = Object(framer_motion_es["b" /* useMotionValue */])(0); // const dragControls = useDragControls();
  // dragControls;

  var background = Object(framer_motion_es["c" /* useTransform */])(x, [-100, 0, 100], ["#ff008c", "#7700ff", "rgb(230, 255, 0)"]);
  return /*#__PURE__*/react_default.a.createElement(framer_motion_es["a" /* motion */].div, {
    style: {
      width: 400,
      background: background
    }
  }, /*#__PURE__*/react_default.a.createElement(framer_motion_es["a" /* motion */].div, {
    drag: true // dragControls={dragControls}
    ,
    dragConstraints: {
      top: -600,
      bottom: 600,
  ...
  }, /*#__PURE__*/react_default.a.createElement(Styled, null, /*#__PURE__*/react_default.a.createElement(ScopedCssBaseline["a" /* default */], null, children))));
};
function Page() {
...
//# sourceMappingURL=component---src-pages-zzz-tsx-7d48c6a42aba52f8726b.js.map